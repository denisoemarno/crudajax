...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color: white;"><b>Manage Data Siswa</b></a>
        </div>
        <p class="navbar-text navbar-right hidden-xs">
          <a href="../index.php" style="color: white;" class="btn btn-primary">Kembali
    ...
    <div style="padding: 0 15px;">
      ...
      -->
      <div id="view"><?php include "../datasiswa/view.php"; ?></div>
    </div>
    ...
    <script src="../assets/js/ajaxsiswa.js"></script>
  </body>
</html>